...
@Composable
fun ActionSetupCard(action: Action, idx: Int? = null) {
    Card(
...
fun PreviewActionWorkCardLight() {
    ProductivityTheme {
        Surface {
            ActionSetupCard(Action.Work(15.minutes + 30.seconds, "Study"))
            Spacer(Modifier.padding(16.dp))
            ActionSetupCard(Action.Work(15.minutes + 30.seconds, "Study"), 1)
        }
    }
}
...
fun PreviewActionRestCardLight() {
    ProductivityTheme {
        Surface {
            ActionSetupCard(Action.Rest(7.minutes + 30.seconds))
            Spacer(Modifier.padding(16.dp))
            ActionSetupCard(Action.Rest(7.minutes + 30.seconds), 1)
        }
    }
}
