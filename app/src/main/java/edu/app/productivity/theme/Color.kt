...
val MossGreen = Color(0xFF93A168)
val TeaGreen = Color(0xFFCCD5AE)
val Beige = Color(0xFFE9EDC9)
val CornSilk = Color(0xFFFEFAE0)
val PapayaWhip = Color(0xFFFAEDCD)
val Buff = Color(0xFFD4A373)
val Russet = Color(0xFF84552A)
val CafeNoir = Color(0xFF4C321A)

val Cordovan = Color(0xFF944C4C)
val Garnet = Color(0xFF6C3737)
val CaputMortuum = Color(0xFF512A2A)
